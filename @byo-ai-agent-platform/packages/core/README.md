...
| **`@byo-ai-agent-platform/core/tools`** | `OpenAPIToolProvider`, `ComputerUseToolProvider`, `McpServerToolProvider`, `ScratchpadToolProvider`, `TodosToolProvider`, `toolProviderRegistry` | Tool providers including OpenAPI specs, Computer primitives, MCP servers, Scratchpad, and Todos. |

...
echo "========================================================"
echo " BYoAI Platform - Docker Computer Use Compose Launcher"
echo "========================================================"
...
echo ""
echo "Starting Docker Computer Use Full Stack Compose services:"
echo "  - Identity Provider (Mock OAuth2/OIDC): http://localhost:8090/default"
echo "  - Computer Controller (Docker Mode):   http://localhost:8080"
